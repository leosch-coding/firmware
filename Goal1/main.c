...
void main(void) {
    ...
    *RCC_APB1ENR |= 0b1;
    ...
    volatile uint32_t *TIM2_PSC = (uint32_t *)0x40000024;
  
    // Move 15 into TIM2_PSC
    *TIM2_PSC = 15;

    volatile uint32_t *TIM2_ARR = (uint32_t *)0x40000028;
    ...
    *NVIC_ISER0 |= 0b0000100000000000000000000000000;

    volatile uint32_t *RCC_AHB1ENR = (uint32_t *)0x40023830;

    *RCC_AHB1ENR |= 0b1;
  
    *GPIOA_MODER &= 0b11111111100111111111111111111111;
    *GPIOA_MODER |= 0b00000000001000000000000000000000; 
